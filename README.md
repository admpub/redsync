...
[![Build Status](https://travis-ci.org/admpub/redsync.svg?branch=master)](https://travis-ci.org/admpub/redsync)
...
Install Redsync using the go get command:
    ...
    $ go get github.com/admpub/redsync/v4
...
import (
	...
	"github.com/admpub/redsync/v4/redis/goredis/v8"
)
